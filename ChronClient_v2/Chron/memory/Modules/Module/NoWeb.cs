...
namespace ChronClient.Module
{
    public static class NoWeb
    {
        public static void OnLoad()
        {
            ...
            moduleClass.ModuleName = "NoWeb";
            moduleClass.Category = "Movement";
            moduleClass.Description1 = "Prevents slowing down when being in a web";
        ...
        public static class Events
        {
            ...
            {
                Game.m.PatchMemory("Minecraft.Windows.exe", 0x130BD15, new byte[] { 0xEB });
            }
            public static void OnDisable()
            {

                Game.m.PatchMemory("Minecraft.Windows.exe", 0x130BD15, new byte[] { 0x76 });
            }
