...
{
    public static class SpeedFall
    {
        public static void OnLoad()
        {
            ModuleClass moduleClass = new ModuleClass();
            moduleClass.ModuleName = "SpeedFall";
            moduleClass.Category = "Movement";
            moduleClass.Description1 = "Allows you to fall fast";
        ...
        public static class Events
        {
            ...
            {
                Game.m.PatchMemory("Minecraft.Windows.exe", 0x14A049F, new byte[] { 0xB8, 0x10, 0x00, 0x00, 0x00, 0x90, 0x90 });
            }
            public static void OnDisable()
            {
                Game.m.PatchMemory("Minecraft.Windows.exe", 0x14A049F, new byte[] { 0x0F, 0xB6, 0x83, 0xA0, 0x01, 0x00, 0x00 });
            }
