...
namespace Chrones
{
    public static partial class Cmr
    {
        public static partial class Win32
        {
            ...
            [DllImport("user32.dll")]
            public static extern uint SendInput(uint nInputs, [MarshalAs(UnmanagedType.LPArray), In] MOUSEINPUT[] pInputs, int cbSize);
            [DllImport("user32.dll")]
            public static extern uint SendInput(uint nInputs, [MarshalAs(UnmanagedType.LPArray), In] KEYBOARDINPUT[] pInputs, int cbSize);
            [DllImport("User32.dll")]
